...
const legalData = {
    privacy: `
        ...
        <p>Your privacy is important to us. This Privacy Policy explains how SecureDrive Insurance ("we," "us," or "our") collects, uses, shares, and protects your information when you use our website and services. By using this website, you agree to the practices described in this Privacy Policy. If you do not agree, please do not use the site.</p>

        <h3>1. Who We Are</h3>
        <p>SecureDrive Insurance is an <strong>advertising and affiliate marketing website</strong> that connects users with third-party licensed insurance providers. We are <strong>not an insurance carrier</strong> and do not issue or underwrite insurance policies.</p>
        ...
        <p>To exercise any of these rights, please contact us at <a href="mailto:info@securedrive-insurance.com">info@securedrive-insurance.com</a>.</p>
    ...
    terms: `
        ...
        <p>SecureDrive Insurance provides a platform that connects consumers with third-party insurance agents, brokers, and carriers. We are an administrative and marketing entity and:</p>
        <ul>
        ...
        <p>By submitting your phone number and information, you provide express written consent to be contacted via telephone, automated dialing systems, artificial/pre-recorded messages, or text messages by <strong>SecureDrive Insurance</strong> and <strong>our partners</strong>.</p>
        <ul>
        ...
        <p>All content, logos, designs, and code on this website are the property of <strong>SecureDrive Insurance</strong> and are protected by copyright and trademark laws. You may not copy, redistribute, or use our branding without express written permission.</p>
